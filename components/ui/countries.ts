/**
 * Country dataset for the PhoneField. ISO-3166 alpha-2 code (for flag image),
 * display name, and E.164 dial code. Flags are rendered from flagcdn.com images
 * (https://flagcdn.com/{w}x{h}/{iso}.png) so real flags render on every OS —
 * unlike emoji flags, which do not display on Windows.
 */
